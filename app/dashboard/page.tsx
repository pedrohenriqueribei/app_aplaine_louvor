        ...
        {cards.map((card, idx) => (
          <Link href={card.href} key={card.label} className="block">
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all group h-full"
            >
              <div
                className={`w-14 h-14 ${card.bg} dark:bg-opacity-20 rounded-2xl flex items-center justify-center ${card.color} dark:text-opacity-90 mb-6 group-hover:scale-110 transition-transform`}
              >
